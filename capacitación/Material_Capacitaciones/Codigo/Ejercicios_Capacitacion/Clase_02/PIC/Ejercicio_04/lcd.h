...
#define TRIS_LCD_E      	TRISC
#define PORT_LCD_E          PORTC
#define LCD_E               3
#define TRIS_LCD_RS     	TRISC
...
#define LCD_START_LINE1  0x00     /* TRISAM address of first char of line 1 */
#define LCD_START_LINE2  0x40     /* TRISAM address of first char of line 2 */
#define LCD_START_LINE3  0x14     /* TRISAM address of first char of line 3 */
#define LCD_START_LINE4  0x54     /* TRISAM address of first char of line 4 */
