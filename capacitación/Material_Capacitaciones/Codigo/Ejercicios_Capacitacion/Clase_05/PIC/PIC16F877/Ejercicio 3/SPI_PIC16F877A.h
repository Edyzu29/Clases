...
/*Como hay dos dispositivos esclavos, tenemos que activar uno y desactivar el otro
    Para usar el mismo Pin, usaremos una compuerta negada con uno de los esclavos*/
#define CS1_ON()      PORTC &= ~(1<<CS)
#define CS2_ON()      PORTC |= (1<<CS)
