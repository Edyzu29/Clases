...
typedef enum{
	...
	Timer_8b_Fast_PWM_AdjPeriod_Mode = 5,
	Timer_8b_Phase_Correct_PWM_AdjPeriod_Mode = 7
}Timer_8b_Mode_t;
...
typedef enum{
	Timer_Interrupts_Disabled = 0,
	Timer_Overflow_IE = 1,
	Timer_CompA_IE = 2,
	Timer_CompB_IE = 4,
	Timer_InputCapt_IE = 32
}Timer_Interrupt_Mask_t;
...
typedef struct{
	...
	Timer_Interrupt_Mask_t interrupt_mask;
}Timer_8b_t;
